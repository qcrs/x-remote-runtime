#ifndef COREX_DEVICE_INFO_G8C_H
#define COREX_DEVICE_INFO_G8C_H
...
#define G8C_DEVICE_INFO_DTO_VERSION 1u
#define G8C_DEVICE_NAME_BYTES 256u

typedef struct CorexRemoteDeviceInfo {
    char name[G8C_DEVICE_NAME_BYTES];
